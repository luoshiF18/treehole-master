...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:/ProgramTool/ffmpeg-20180227-fa0c9d6-win64-static/bin/ffmpeg.exe";//ffmpeg的安装位置
    ...
    /**
     * 构造方法
     * @param ffmpeg_path   ffmpeg的安装路径
     * @param video_path    视频地址
     * @param mp4_name       生成的视频名称
     * @param mp4folder_path 生成的视频路径
     */
