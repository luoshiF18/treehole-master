...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.treehole.com/#/learning/${courseBase.id}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
	    ...
	    <#if (coursePic.pic)??>
	     <p><img src="http://img.treehole.com/${coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
                                    ...
                                    <div class="drop-down" style="height: ${firstNode.children?size * 50}px;">
                                        <ul class="list-box">
                                            <#list firstNode.children as secondNode>
                                                <li><a href="http://ucenter.treehole.com/#/learning/${teachplanNode.courseid}/${secondNode.id}">${secondNode.pname}</a></li>
                                            </#list>
                                        </ul>
                                    </div>
                                </div>
